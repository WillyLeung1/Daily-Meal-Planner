              ...
              <form>
                <Tabs defaultIndex={0} ref={component => { this.tabs = component }} className="Survey__tabs">
                  ...
                  <Tab heading="6">
                    ...
                    <input type="number" value={cookingTime} onChange={this.handleCookingTime} min="15" />
                    <p>Calories Range: {calories.min} - {calories.max} kcal</p>
                    {cookingTime < 25 && (
                      <p className="warning">
                        Please note that the preferred cooking time is less than 30 minutes. <br />
                        Some meals might not fit within this time while still meeting the calorie range of {calories.min} - {calories.max} kcal.
                      </p>
                    )}
                    <div className="Survey__goto">
                      <Button name="back" onClick={this.goTo} className="Survey__goto__button--back">Back</Button>
